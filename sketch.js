...
function preload(){
  ...
  //you have to preload sound if you want to add sounds.
  catchSound = loadSound("Ta Da-SoundBible.com-1884170640.mp3");
  losepointSound = loadSound("sad_Trombone-Joe_Lamb-665429450.mp3");
  matchloseSound = loadSound("dun_dun_dun-Delsym-719755295.mp3");
  matchwinSound = loadSound("Audience_Applause-Matthiew11-1206899159.mp3");
}
...
// is touching condition when pokemons touch pokeball the catched score will get increased.
  if(pokemonGroup.isTouching(ballGroup)){
    ...
    //adds score to the catched.
    score = score +1;
    
    //adds sound when pokemon catched.
    catchSound.play();
    }
